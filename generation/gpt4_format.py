...
# tasks = ['topology']
with open('/cpfs/user/chennuo/CN/Graph_RFT_Data/gpt4data/gpt4_nlgtest_augreverse.json',  'a', encoding='utf-8') as writer:
    rights = 0
    for task in tasks:
        ...
        # exemplar = 'Q:'.join(exemplar.split('Q:')[:2])
        exemplar = ''
        with open(f'/cpfs/user/chennuo/CN/Graph-Reasoning-LLM/datasets/test_set_v4_3600/{task}_test.json') as f:
            datas = f.readlines()
        ...
        for data in tqdm(datas):
            ...
            new_data['max_tokens'] = 1000
            new_data['temperature'] = 0.0
            new_data['n'] = int(1)
